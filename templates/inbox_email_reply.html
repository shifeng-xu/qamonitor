      ...
      <form class="emailCompose form-horizontal" action="#" method="POST">
         <div class="emailField address">
            ...
            <div class="fields fieldsTo">
               <input class="form-control" name="to" value="john.doe@fametaxi.com, jane.doe@gmail.com, support@fametaxi.com" type="text">
               <span id="cc-bcc">
				   <span class="emailCC" style="display:none">CC</span>
				   <span class="emailBCC">BCC</span>
               </span>
            </div>
         </div>
         <div class="emailField inputCC">
         	<button type="button" class="close" aria-hidden="true">&times;</button>
            <label class="control-label">CC:</label>
            <div class="fields fieldsCC">
               <input name="cc" class="form-control" value="managers@fametaxi.com, social@fametaxi.com" type="text">
            </div>
         </div>
         ...
         <div class="emailField">
            ...
            <div class="fields">
               <input class="form-control" name="subject" value="RE: Design document approved" type="text">
            </div>
         </div>
         <div class="emailField">
            ...
            <div class="controls-row">
               <div id="reply-content">
                  ...
                  <blockquote>
                     Dear Ms. McDonald,<br>
					 I am writing to follow up on our discussion last Wednesday. As you requested, I filed a work order with the facilities department regarding the damage to the ascending escalator you reported.<br>
					An examination of the escalator found that there was a shoelace caught in the gears. Said shoelace has since been removed, and the escalator was tested extensively to ensure this would not happen again. I am pleased to report that the tests were passed with flying colors, and the escalator has been reopened.<br>
					Thank you for bringing this issue to our attention. Please continue to inform us should you have any other problems in our facilities.<br>
					Sincerely,<br>
					Marilyn Novak<br>
					Property Manager<br>
					Novak Skyscraper Construction<br>
                  </blockquote>
               </div>
            </div>
         </div>
